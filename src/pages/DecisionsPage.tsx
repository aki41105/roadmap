...
const keyDecisionDetails = [
  {
    ...
    criteria: ["博士論文との接続", "M2・D1をまたぐ受入身分と正式手続き", "修士審査・博士入学との両立", "倫理・データ・住居・資金"],
    provisional: "NII本命、京都大学HRIは条件付き",
    contact: "指導教員、JAIST関係窓口、候補教員",
    next: "最近の論文を読み、2026年秋に1〜2ページの個別提案を送る",
  },
  {
    title: "海外研究先",
    due: "2027年8月31日",
    options: ["海外大学で6か月の共同研究", "終了日を固定して5か月へ短縮", "国内から共同解析"],
    criteria: ["受入先・テーマ", "資金", "倫理・データ移転・知財", "ビザ・住居", "2028年3月末までに帰国"],
    provisional: "2027年10月〜2028年3月の大学研究",
  ...
  },
  {
    title: "D2企業インターン先",
    due: "2028年4月30日",
    options: ["OMRON・Sony・NEC・日立・Woven等で6〜8週間", "期間調整できる別企業へ変更", "博士論文・就活を優先して見送る"],
    criteria: ["別の研究質問", "6〜8週間", "公開・知財・博士論文利用", "終了後アクセス", "D2の選考日程と両立できる"],
    provisional: "企業名より条件で一社を選ぶ",
    contact: "指導教員、JAIST窓口、企業メンター・契約担当",
    next: "D1留学中から候補を比較し、帰国後の2028年4月に確定する",
  },
  {
    title: "引っ越し",
    due: "海外留学終了後・2028年4〜5月目安",
  ...
  },
  {
    ...
    next: "D1で20組織調査・8面談を行い、D2で応募・選考・内定承諾まで終える",
  },
] as const;
