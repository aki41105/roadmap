...
const keyDecisionDetails = [
  ...
  },
  {
    ...
    criteria: ["受入先・テーマ", "資金", "倫理・データ移転・知財", "ビザ・住居", "2029年2月末までに帰国"],
    provisional: "2028年9月〜2029年2月の大学研究",
  ...
  },
  {
    title: "D2企業インターン先",
    due: "2028年4月30日",
    options: ["OMRON・Sony・NEC・日立・Woven等で6〜8週間", "期間調整できる別企業へ変更", "海外研究を優先して見送る"],
    criteria: ["別の研究質問", "6〜8週間", "公開・知財・博士論文利用", "終了後アクセス", "8月を渡航準備に残せる"],
