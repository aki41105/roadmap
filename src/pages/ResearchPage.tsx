...
const researchThemes = [
  ...
  },
  {
    ...
    collaborator: "M2末〜D1開始の国内滞在候補と方法論を検討",
...
const thesisChapters = [
  ...
  ["第3章", "研究A：推定", "既存共同研究＋D1企業研究", "D1投稿"],
  ["第4章", "研究B：予測", "M2末の国内滞在＋D1海外研究", "D1〜D2投稿"],
  ["第5章", "研究C：適応", "D1海外研究＋D2企業研究", "D2投稿"],
...
const publicationPlan = [
  ...
  ["M2→D1", "国内滞在成果", "2027年6月までに投稿または投稿可能原稿", "7月の企業研究前に新規実験を止める"],
  ["D1", "企業研究論文", "2027年9月に成果を凍結し、年内投稿を内部目標", "留学中は追加実験より共同執筆"],
  ["D1→D2", "海外共同研究論文", "2028年3月に成果を凍結し、4〜5月に統合", "6か月の外的妥当性・一般化"],
  ["D2", "企業研究論文", "2028年7月に成果を凍結し、年内投稿", "就活と並行できる執筆範囲に限定"],
] as const;
    ...
    <>
      ...
      >
        ...
        <Callout title="論文数より接続を優先" badge="確定" tone="success">
          <p>
            D1・D2でそれぞれ一社・一原稿を目標にしますが、投稿本数を増やすことより、
      ...
      >
        ...
        />
        <h3 className="rm-subheading">四つの外部研究と成果</h3>
      ...
      >
        <CardGrid columns={2}>
          ...
          <Card title="学位工程を守る条件" badge="予定">
            <BulletList
              items={[
                "就活はD2中に終え、D3は新しい企業研究・応募・選考を入れず博士論文の完成に集中する。",
