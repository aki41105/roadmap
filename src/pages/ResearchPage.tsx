...
const thesisChapters = [
  ...
  ["第5章", "研究C：適応", "D2企業研究＋6か月の海外共同研究", "D2〜D3投稿"],
...
const publicationPlan = [
  ...
  ["D2", "企業研究論文", "2028年8月に成果を凍結し、留学中も共同執筆", "6〜8週間の研究から論文1本を完成"],
  ["D2〜D3", "海外共同研究論文", "2029年3月に成果統合、D3前半に投稿", "6か月の外的妥当性・一般化"],
] as const;
      ...
      >
        <CardGrid columns={2}>
          ...
          <Card title="学位工程を守る条件" badge="予定">
            <BulletList
              items={[
                "D3は新しい企業研究を入れず、博士論文の完成と就職先の決定に集中する。",
