...
const pendingDecisions = [
  ...
  },
  {
    title: "D2夏の企業研究先",
    due: "2028年3〜4月",
    provisional: "日立を含む6〜8週間・論文公開可能な一社",
    next: "期間、知財、博士論文利用、終了後アクセスを比較",
    href: "/roadmap/internships/",
  },
  {
    title: "海外研究先と資金",
    due: "2028年9月30日",
    provisional: "2028年11月〜2029年1月の3か月検証枠",
...
export function OverviewPage() {
  return (
    <>
      <Lead>
        2030年3月の博士修了を最優先に、D1・D2・D3の夏は一社で論文型企業研究、
        D1冬は国内で方法論、D2冬は海外で外的妥当性を補います。今はM2で、
