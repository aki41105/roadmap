...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    outside: "CyberAgentの長期・論文型へ応募。国内6〜8週間滞在は同じ夏枠の代替案に切り替える。",
    life: "資金を確定し、週次または隔週の指導面談を固定する。",
  },
  {
    period: "2027 Q3",
    stage: "D1",
    research: "CyberAgentを本命に6〜8週間の主実験。不成立なら国内研究滞在で研究1を進める。",
    outside: "D1の長期枠は一つ。CyberAgentが不成立なら国内研究滞在または豊田中央研究所へ入れ替える。",
    life: "長期枠を実施する年は山小屋を見送り、終了後3〜5日の回復日を置く。",
  },
  {
    period: "2027 Q4",
    stage: "D1",
    research: "D1夏に選んだCyberAgentまたは国内研究の成果を6〜8週間で執筆・投稿する。",
    outside: "CyberAgent成果を投稿できた場合だけ、D1冬の国内研究滞在を最終合意する。",
    life: "引っ越し候補を調べるが、まだ固定費は増やさない。",
  },
  {
    period: "2028.01–03",
    stage: "D1",
    research: "CyberAgent実施・投稿済みなら国内研究滞在。国内滞在をD1夏に実施済みなら投稿と海外準備に固定。",
    outside: "冬の国内滞在は6〜8週間。企業論文未投稿なら1〜2週間へ縮小し、投稿を優先する。",
    life: "引っ越しと車は、海外留学後の負担まで含めて判定する。",
  },
  {
    period: "2028.04–06",
    stage: "D2",
    research: "D1外部研究の残る成果を投稿し、海外共同研究の予備実験、倫理、データ契約を完成。",
    outside: "大学か海外企業の一つを6月末までに選び、国内の新規長期案件は入れない。",
  ...
  },
  {
    ...
    stage: "D2",
    research: "海外成果を2029年1月末までに投稿し、博士論文の全体構成を作る。",
    outside: "投稿済み・体調安定なら2月にNTT R&Dを2〜3週間。未達なら中止して就活へ。",
    life: "海外留学後に住居を再判定。生活防衛資金を確認する。",
  },
  {
    period: "2029 Q2",
    stage: "D3",
    research: "主要結果と全章アウトラインを3月末までに固定し、5月に博士論文初稿を40〜50%まで進める。",
    outside: "学位ゲート通過かつ海外枠が大学留学だった場合だけD3企業枠。OMRONは1か月可テーマ、Sonyは原則面談候補。就活は6月終了。",
    life: "新規バイトと高額支出を止める。",
  },
  {
    period: "2029 Q3",
...
export const scenarioOptions = [
  {
    key: "A",
    title: "安全重視",
    projects: "大型最大3回 ＋ NTT短期",
    papers: "独立研究2本＋博士論文",
    life: "山小屋3〜6日、車は修了後",
    risk: "D3企業枠は使わず、学位を守る",
  },
  {
    key: "B",
    title: "バランス",
    projects: "大型最大3回 ＋ 短期0〜2回",
    papers: "独立研究3本、2〜3本採択目標",
    life: "山小屋は見送り、車は修了後",
    risk: "D2・D3短期は学位ゲート未達なら中止",
    recommended: true,
  },
  {
    key: "C",
    title: "挑戦",
    projects: "B案の短期2回を無条件で固定",
    papers: "独立研究3本＋短期パイロット",
    life: "山小屋1か月、D2で車購入",
    risk: "投稿・回復・学位ゲートを破るため非推奨",
  },
];
...
export const externalProjects = [
  {
    ...
    purpose: "既存の共同研究、実環境HRIデータ、ラポール・離脱研究を使い、3回の中で唯一の論文本命にする。",
    caution:
      "2027年度募集と実施時期は未公表。2027年夏の実施は一つにし、採択時は国内滞在を投稿後のD1冬へ移す。",
  },
  {
    number: "02",
    time: "D1 · 2028.01–02",
    ...
    duration: "6〜8週間",
    result: "方法論強化・国内共同論文",
    purpose: "企業と異なる学術環境でHRI方法論を強化し、国内の共同研究ネットワークをつくる。",
    caution:
      "CyberAgent成果が投稿済みの場合だけ実施。国内滞在をD1夏に実施済みなら繰り返さず、投稿と海外準備へ固定する。",
  },
  {
    number: "03",
    time: "D2 · 2028.09–11",
    title: "海外大学／企業研究",
    duration: "3か月",
    result: "国際共同論文・海外研究経験",
    purpose: "海外大学研究留学か海外企業研究インターンの一つを選び、共同研究を完成させる。",
    caution:
      "両方へ応募してよいが実施は一つ。資金、倫理、知財、データ移転、在留資格を個別確認する。",
  },
  {
    number: "S1",
    time: "D2 · 2029.02",
    title: "NTT R&D · 研究所探索",
    duration: "2〜3週間、最大4週間",
    result: "パイロット・研究人脈・就職判断",
    purpose: "対話LLM・社会的信号・エージェント研究を短期で試し、大企業研究所との相性を確認する。",
    caution:
      "海外成果を1月末までに投稿でき、帰国後8週間を確保できる場合だけ実施。知財はNTT帰属で、論文利用は要確認。",
  },
  {
    number: "S2",
    time: "D3 · 2029.04–05",
    title: "OMRON／Sony · キャリア判断",
    duration: "最大1か月相当・条件付き",
    result: "就職先判断・追加検証",
    purpose: "博士研究の主要結果を完成させた後に、現場の研究者と働き方・研究公開・配属テーマを確かめる。",
    caution:
      "OMRONは実際に1か月可の課題がある場合のみ。Sonyの現行条件は3か月以上・週2日以上で高リスク。3月末の学位ゲート未達なら中止する。",
  },
];
...
export const internshipWindows = [
  {
    status: "D1 · 論文",
    time: "2027.07–10",
    title: "CyberAgentで6〜8週間〜2か月",
    text: "3回の中で唯一の論文本命。2027年夏の実施は一つにし、国内滞在は採択時だけ投稿後のD1冬へ移す。",
  },
  {
    status: "D2 · 探索",
    time: "2029.02",
    title: "NTT R&Dで2〜3週間",
    text: "海外成果を1月末までに投稿済みで、帰国後8週間を確保できるテーマだけ。最大4週間を超える場合は見送る。",
  },
  {
    status: "D3 · 条件",
    time: "2029.04–05",
    title: "キャリア確認は最大1か月相当",
    text: "3月末に主要結果・章構成・投稿がそろった場合だけ。5月末までに終わらない条件なら、研究者面談または中止へ変える。",
  },
];

export const internshipThreeYearRules = [
  "D1の長期・論文型成果を、次の大型案件前に投稿する",
  "2027年夏はCyberAgentと国内滞在の一方だけ。企業採択時だけ国内滞在をD1冬へ移し、夏に実施済みなら繰り返さない",
  "海外帰国からNTT開始まで8週間を空け、海外論文を1月末までに投稿する",
  "NTTは2〜3週間、本計画上の上限は4週間とする",
  "海外3か月を企業インターンにした場合はD3企業枠を使わず、企業参加を合計3回以内にする",
  "D3開始時に主要3章の結果・全章構成・独立研究2本以上の投稿をそろえる",
  "D3企業活動は5月末までに完全終了する",
  "条件未達なら3回目を中止し、研究者面談または1週間の訪問へ縮小する",
];
...
export const nttInternshipThemes = [
  ...
  },
  {
    ...
    text: "NTTs26064。視線・動作データに基づく触診インタラクションのマルチモーダル解析。4週間以上6週間未満だった。",
  },
  {
    key: "03",
    label: "RELATED THEMES",
    title: "パーソナルAI・行動予測・不確実性",
    text: "NTTs26044・46・48。LLMプロンプト最適化、歩行者の危険行動予測、移動エージェントの状況認識を扱った。",
  },
];
...
export const shortInternshipCandidates = [
  {
    name: "豊田中央研究所",
    period: "2026実績 · 平日10日",
    role: "D1長期またはD2 NTTの補欠",
    facts: "ID 65の人―人相互作用の状態推定・介入、ID 11の屋内人行動理解など、研究適合の高いテーマがあった。",
    caution: "CyberAgent・NTTへ追加する4回目にはしない。いずれかが不成立の年に入れ替え、論文・単位には数えない。",
...
export const toyotaEcosystem = [
  {
    ...
    rule: "CyberAgentまたはNTTが不成立のときの補欠。追加の4回目にはしない。",
...
export const internshipStrategyOptions = [
  {
    label: "D1 · 入れ替え",
    title: "CyberAgentか国内滞在の一つ",
    text: "同じ夏に二つ行わない。CyberAgentが成立すれば論文本命にし、国内滞在はD1冬へ移すか1〜2週間へ縮小する。",
  },
  {
    label: "D2 · 投稿ゲート",
    title: "海外論文未投稿ならNTTを中止",
    text: "2029年1月末に投稿済み、帰国後8週間、体調安定、適合テーマ2〜3週間のすべてを満たす場合だけ2月に実施する。",
  },
  {
    label: "D3 · 学位ゲート",
    title: "3回目は上限、必達ではない",
    text: "主要結果・投稿・全章構成が3月末にそろい、5月末までに終了できる案件だけ。未達なら面談または中止へ変える。",
  },
];
...
export const internshipPrep = [
  ...
  },
  {
    time: "2027.01–06",
    title: "D1長期枠を確定",
    text: "CyberAgentの募集を毎月確認し、企業別提案と契約条件を準備。6月に国内滞在とのどちらか一つへ決める。",
  },
  {
    time: "2027.07–12",
    title: "実施し、年内に投稿",
    text: "6〜8週間の主実験を進め、終了後6〜8週間で投稿。未投稿ならD1冬の国内滞在を縮小する。",
  },
  {
    time: "2028.08–11",
    title: "NTT冬期へ備える",
    text: "CV・希望テーマ基準・指導教員了承を8月までに準備。海外滞在中の10〜11月は、現地研究を妨げない範囲で応募する。",
  },
  {
    time: "2029.01–05",
    title: "二つの学位ゲート",
    text: "1月末に海外論文でNTTを判定し、3月末に主要結果・投稿・全章構成でD3企業枠を判定。未達なら中止する。",
  },
];
...
export const degreeMilestones = [
  ...
  },
  {
    ...
    internal: "3月末に全章アウトライン、5月に初稿40〜50%",
  },
  {
    time: "2029.10",
...
export const careerSteps = [
  ...
  ["D2 前半", "応募先を5〜8社へ絞り、海外枠の候補を確定"],
  ["D2 秋", "海外研究を優先しつつ、NTT冬期は準備済み資料で応募"],
  ["D2 冬", "海外論文投稿後だけNTTで研究所文化を確認"],
  ["2029.03–06", "D3企業枠は学位ゲート付き。主要選考は6月終了を目標"],
];
...
export const decisionGates = [
  ...
  },
  {
    time: "2027.06",
    title: "D1長期インターン",
    go: "CyberAgentの受入・研究質問・メンター・公開条件・帰任後6週間が確定",
    stop: "不成立なら国内滞在または豊田中央へ入れ替え、同時実施しない",
  },
  {
    time: "2027.12",
    title: "国内研究滞在",
    go: "CyberAgent成果が投稿済みで、国内受入・倫理・資金・著者・投稿先が確定",
    stop: "企業論文が未投稿、または国内滞在をD1夏に実施済みなら縮小・中止",
  },
  {
    time: "2028.02",
    title: "引っ越し",
  ...
  },
  {
    time: "2029.01",
    title: "NTT R&D",
    go: "海外論文が1月末までに投稿済み、帰国後8週間、体調安定、2〜3週間の適合テーマ",
    stop: "一つでも未達、4週間超、選考が海外研究を妨げる場合は中止",
  },
  {
    time: "2029.03",
    title: "D3企業枠",
    go: "海外枠が大学留学で、主要3章の結果、独立研究2本以上の投稿、海外論文投稿、全章構成、NTT残務なし",
    stop: "海外枠が企業、または学位条件が不足なら中止。面談か1週間の訪問へ縮小",
  },
  {
    time: "2029.06",
    title: "就活",
...
export const riskRows = [
  ...
  ["D2が過密", "海外帰国からNTTまで8週未満、または海外論文未投稿", "NTTを中止"],
  ["D3論文が遅れる", "2029年3月末に主要3章・全章構成・投稿が不足", "3回目を中止"],
...
export const recoveryWindows = [
  ["2027.03", "修士修了後7〜10日"],
  ["2027 D1長期後", "3〜5日＋投稿期間6〜8週間"],
  ["毎年12月末", "3〜5日の完全休養"],
  ["2028 夏", "国内滞在と海外の間を最低8週間"],
  ["2028.12–2029.01", "海外帰国からNTTまで8週間"],
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        note: "実施は2026年1〜3月の2〜3週間。2028年度条件は再確認",
      },
      {
