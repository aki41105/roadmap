...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    period: "2028 Q3",
    stage: "D2",
    research: "企業成果を論文化。海外研究の倫理・データ準備を完了。",
    outside: "大型案件の間を8週間以上空ける。",
  ...
  },
  {
    ...
    outside: "海外研究留学3か月。帰国後6週間以内の投稿計画まで合意。",
...
export const decisionGates = [
  ...
  },
  {
    time: "2028.08",
    title: "海外研究留学",
    go: "前案件を投稿済み。3か月の資金・倫理・データ・ベースラインが揃う",
    stop: "健康不安、前案件未投稿、案件間隔8週未満なら延期",
  },
  {
    time: "2029.03",
    title: "D3移行",
...
export const sourceGroups: { title: string; links: LinkItem[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        label: "JSPS特別研究員",
        href: "https://www.jsps.go.jp/j-pd/pd_oubo.html",
      },
      {
        label: "JST SPRING",
