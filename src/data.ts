...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    ...
    outside: "D2夏の企業研究は一社だけ。公開・知財・博士論文利用、終了日、帰任後のアクセスと執筆担当を開始前に固定する。",
    life: "TA・RAと一般アルバイトを重ねず、8月を成果整理・回復・渡航準備の月として守る。",
  },
  {
    period: "2028.08",
    stage: "D2",
    research:
      "D2企業成果を凍結・原稿化し、海外大学で進める研究の条件・実装・予備実験を最終確認する。",
    outside:
      "受入・資金・倫理・住居・保険・ビザを最終確認し、9月の出発へ備える。",
    life: "投稿、休養、渡航準備を重ねすぎない。車は原則として修了後へ延期する。",
  },
  {
    period: "2028.09–2029.02",
    stage: "D2",
    research: "海外大学で6か月の共同研究を進め、博士論文の一章と投稿原稿1本を完成に近づける。",
    outside: "D2の中心となる海外研究留学。企業インターンを追加せず、現地の方法・設備・共同指導を生かす。",
    life: "助成と二重家賃を管理し、帰国後に住居と生活防衛資金を再判定する。",
  },
  {
    period: "2029.03",
    stage: "D2",
    research: "帰国後に海外成果を統合し、博士論文の主要章・図表・全体構成を固定する。",
    outside: "D3の新規インターンは計画せず、共同研究の引き継ぎと就職先の絞り込みだけを行う。",
    life: "帰国直後は低負荷にし、投稿・就活・D3準備を同時に増やしすぎない。",
  },
  {
    period: "2029 Q2",
    stage: "D3",
    ...
    outside:
      "新しい研究インターンは入れず、就活の主要判断を6月までに終えて博士論文へ集中する。",
    life: "新規バイトと高額支出を止める。",
  },
  {
    period: "2029 Q3",
...
export const scenarioOptions = [
  {
    ...
    life: "山小屋3〜6日、車は修了後",
    risk: "D1企業論文が未投稿なら国内滞在を1〜2週間へ縮小し、D3に外部活動を追加しない",
  },
  {
    key: "B",
    title: "バランス",
    projects: "D1・D2夏の企業2回 ＋ D1国内滞在 ＋ D2海外大学6か月",
    papers: "企業論文2本＋国内の理論補強＋海外共同論文＋博士論文",
    life: "山小屋は見送り、車は修了後",
    risk: "D1企業論文が未投稿なら国内滞在を縮小し、D2留学は2029年2月末の終了日を固定する",
    recommended: true,
  },
  {
    key: "C",
    ...
    life: "山小屋1か月、D2で車購入",
    risk: "D1論文、D2の半年留学、生活資金を同時に圧迫するため非推奨",
  },
];
...
export const externalProjects = [
  ...
  {
    number: "04",
    time: "D2 · 2028.09–2029.02",
    title: "海外大学研究 · 長期共同研究",
    duration: "6か月",
    result: "国際共同研究・外的妥当性",
    purpose: "D2企業論文とは役割を分け、海外大学のデータ・設備・方法を使って博士論文の一章を深める。",
    caution:
      "2028年8月を成果整理・回復・渡航準備に残し、終了日は2029年2月末から延ばさない。資金・倫理・データ移転を出発前に確定する。",
  },
];
...
export const internshipThreeYearRules = [
  ...
  "D2企業は7月中に終了し、8月を成果整理・回復・海外渡航準備に残す",
  "D3は新規インターンを行わず、博士論文・審査・就職決定に集中する",
];
...
export const internshipRules = [
  ...
  },
  {
    label: "この計画",
    title: "D1・D2に各6〜8週間",
    text: "どちらも論文成果を目指す。D2は7月中に終え、8月を海外留学への移行月として保護する。D3には入れない。",
...
export const internshipStrategyOptions = [
  ...
  },
  {
    label: "D2 · 論文2",
    title: "別企業で研究文化を比較",
    text: "OMRON、Sony、NEC、日立、Woven、NTT等から一社を選び、6〜7月の6〜8週間で本格研究を行う。8月を成果整理・回復・渡航準備に使う。",
  },
];
...
export const internshipPrep = [
  ...
  },
  {
    ...
    title: "D2企業と海外をつなぐ",
    text:
      "D2企業は4月30日までに受入・契約・住居を確定。国内滞在成果は4月末に原稿化し、5月15日で新規実験を停止して、6〜7月の企業研究と9月開始の海外大学研究を守る。",
  },
  {
    time: "2028.09–2029.09",
    title: "半年留学からD3論文へつなぐ",
    text:
      "2029年2月まで海外共同研究を進め、3月に回復と成果統合。D3は企業インターンを入れず、博士論文・審査・就職決定へ集中する。",
  },
];
...
export const internshipReject = [
  ...
  "夜・週末にJAIST研究を並行しないと成立しない、またはD2留学の準備期間を失う",
];
...
export const overseasRoadmap = [
  ...
  },
  {
    ...
    label: "D2 · 帰国後",
    title: "回復・成果統合・章構成固定",
    text: "帰国直後は低負荷にし、残実験と執筆を分担。博士論文の主要章と全体構成を固定してD3へ移る。",
  },
];
...
export const overseasExploration = [
  ...
  },
  {
    title: "時期の代替案",
    items: [
      "本命は2028年9月〜2029年2月の6か月",
      "D2企業を2028年6〜7月に実施し、8月を投稿・回復・渡航準備に使う",
      "半年を確保できない場合も終了日は2029年2月末に固定し、開始を10月以降へずらして短縮する",
...
export const jspsRoutes = [
  ...
  },
  {
    ...
    status: "2年間の海外キャリア",
    title: "海外特別研究員（採用予約）",
    body: "博士課程在学中に採用予約へ応募し、学位取得後に2年間海外で研究する制度。D2の6か月留学とは別の、2030年3月修了後の進路候補。",
...
export const overseasGo = [
  "6か月の共同研究が博士論文のどの章を作り、D2企業研究とどう異なるかを説明できる",
  "受入教員・受入身分・定期指導が確定",
  "5月末までに受入先・テーマ・資金・倫理・データの見通しが立つ",
  "7月末までに住居・保険・ビザと出発条件を確定し、8月を回復・渡航準備に残せる",
  "倫理・データ移転・公開可否が確定",
  "ベースラインと予備実験が完了",
  "投稿先・著者順と帰国後の分担を確定し、2029年2月末の終了日を守れる",
];
...
export const overseasDelay = [
  ...
  "論文公開・知財・著者条件が不明",
  "資金不足を現地アルバイトで補う前提",
  "8月に企業作業が残る、渡航準備が未完了、または睡眠・体調が不安定",
];
...
export const careerSteps = [
  ...
  ["D2 夏", "6〜7月に企業研究を実施し、8月を成果整理・回復・渡航準備に残す"],
  ["D2 秋〜冬", "2028年9月〜2029年2月の海外研究を進めながら主要就職先を比較"],
  ["D3 前半", "新規インターンは入れず、主要選考を6月までに終えて博士論文へ集中"],
];
...
export const lifeCards = [
  ...
  },
  {
    ...
    text:
      "D1からシャトル・カーシェア・レンタカーで利用日数を記録。D1冬の国内滞在、D2夏企業、D2の半年留学を行うなら購入は原則として博士修了後。",
...
export const decisionGates = [
  ...
  },
  {
    ...
    stop: "公開不可、博士論文利用不可、8月へ作業が残る、または期間調整不可なら別企業へ変更し、それでも無理なら海外留学を優先",
  },
  {
    time: "2028.05.31",
    title: "海外研究留学・最終GO",
    go: "2028年9月〜2029年2月の受入、研究テーマ、資金、倫理・データの見通しが立ち、7月末までに住居・保険・ビザを確定できる",
    stop: "見通しが立たなければ2029年2月末の終了日を固定したまま5か月以下へ短縮し、D3へ延長しない",
  },
  {
    time: "2029.02",
    title: "引っ越し",
  ...
  },
  {
    ...
    stop: "一つでも未達なら就活候補を絞り、新規活動を止めて博士論文へ集中",
  },
  {
    time: "2029.06",
    title: "就活",
  ...
  },
  {
    ...
    stop: "骨子未提出または進捗悪化なら、就活・任意活動を最小化して章別修正を優先",
  },
  {
    time: "2029.10",
    title: "予備審査願",
...
export const riskRows = [
  ...
  ["D2が過密", "7月末に企業作業が残る、または8月に渡航準備と回復を確保できない", "企業を早く終了し、留学は終了日固定で短縮"],
  ["D3学位が遅れる", "5月31日に主要実験・初稿70〜80%・主要投稿が不足", "就活候補を絞り博士論文へ集中"],
...
export const recoveryWindows = [
  ...
  ["2028.08", "D2企業後の回復・成果整理・渡航準備"],
  ["2029.03", "海外大学研究後1週間は低負荷、その後に成果統合"],
  ["2029.07", "骨子提出後2〜3日"],
