...
export const roadmapItems: RoadmapItem[] = [
  ...
  },
  {
    period: "2028.06–08",
    stage: "D2",
    research: "別企業で2〜3か月の研究2を実施し、主要結果・図表・投稿可能な原稿を持ち帰る。",
    outside: "D2夏の企業研究は一社だけ。公開・知財・博士論文利用、終了日、帰任後のアクセスと執筆担当を開始前に固定する。",
    life: "TA・RAと一般アルバイトを重ねず、終了後2〜4週間の成果整理・回復期間を先に確保する。",
  },
  {
    period: "2028.09–10",
    stage: "D2",
    research:
      "D2企業成果を原稿化し、海外大学で検証する条件・実装・予備実験を最終確認する。",
    outside:
      "9月に受入・資金等を最終判定し、企業終了から海外開始まで最低4週間、可能なら8週間を確保する。住居・保険・ビザは前倒しで準備する。",
  ...
  },
  {
    ...
    outside:
      "D3夏は学位ゲート通過時だけ。企業名を固定せず、既存テーマを扱う2〜4週間の一社を条件付きで比較し、就活の主要判断は6月までに終える。",
    life: "新規バイトと高額支出を止める。",
  },
  {
    period: "2029 Q3",
    stage: "D3",
    research: "7月に学位論文骨子を提出し、博士論文の章別修正を優先する。企業研究は既存テーマの小規模検証だけに限定する。",
    outside:
      "8〜9月のうち原則2〜4週間。NTTを含む候補を比較し、5月末の学位ゲート未達または博士論文進捗悪化時は見学・面談へ縮小するか中止する。",
    life: "骨子提出後2〜3日を低負荷にし、引っ越しをせず、週1日の完全休養を守る。",
  },
  {
    period: "2029 Q4",
    stage: "D3",
    research: "D3企業活動を実施した場合も追加実験をせず博士論文へ直接統合し、10月に予備審査願、12月に予備審査。",
...
export const externalProjects = [
  ...
  },
  {
    ...
    caution:
      "日立・OMRON・Sony・NEC・Woven等の実施年度条件を再確認。海外留学までの移行期間が4週間未満になる場合は6〜8週間へ短縮する。",
  },
  {
    number: "04",
    ...
    caution:
      "D2企業終了から最低4週間、計画上は8週間を確保。企業インターンを追加する第四の必須論文枠にはせず、資金・倫理・データ移転を確認する。",
  },
  {
    number: "05",
    time: "D3 · 2029.08–09",
    title: "企業研究 · 条件付き短期枠",
    duration: "原則2〜4週間",
    result: "小規模追加検証・研究所比較",
    purpose: "NTTを含む複数候補から、既存テーマを扱い博士論文と予備審査準備を妨げない一社だけを条件付きで選ぶ。",
    caution:
      "5月31日の学位ゲート通過、骨子提出、初稿70%以上、主要論文投稿、指導教員承認が条件。未達なら2週間、見学・面談、中止の順に縮小する。",
  },
];
...
export const internshipWindows = [
  ...
  },
  {
    ...
    time: "2028.06–08",
    title: "別企業で2〜3か月",
    text: "OMRON、Sony、NEC、日立、Woven等を比較。海外準備を妨げる場合は6〜8週間へ短縮し、開始まで最低4週間、可能なら8週間空ける。",
  },
  {
    status: "D3 · 条件付き",
    time: "2029.08–09",
    title: "条件を満たす一社で2〜4週間",
    text:
      "NTT固定ではない。主要実験・全章構成・主要図表・初稿70%以上・主要論文投稿・指導教員承認が揃う場合だけ、既存テーマの小規模検証として実施する。",
  },
];

export const internshipThreeYearRules = [
  "各夏は一社だけ。D1は6〜8週間、D2は2〜3か月、D3は条件付き2〜4週間として設計する",
  ...
  "D2企業終了から海外大学研究の開始まで最低4週間、可能なら8週間を空ける",
  "D3企業研究は学位非依存の任意枠とし、博士論文の成立条件にしない",
  "D3は5月31日の学位ゲートを通過し、骨子提出後も博士論文と予備審査準備を妨げない場合だけ最大4週間実施する",
];
...
export const internshipRules = [
  ...
  {
    label: "この計画",
    title: "年次ごとに期間と目的を変える",
    text: "D1は6〜8週間の論文型、D2は2〜3か月の本格企業研究、D3は学位ゲート通過時だけ2〜4週間。単位取得とは別に扱う。",
...
export const internshipCandidates = [
  ...
  },
  {
    ...
    name: "日立",
    role: "D2第一候補・期間適合",
    facts: "博士向け長期有給インターンとして1.5〜3か月の募集実績があり、D2の2〜3か月枠と比較しやすい。",
  ...
  },
  {
    ...
    caution: "2〜3か月で博士論文へ接続でき、海外留学前の移行期間と公開・知財条件を合意できる場合だけ選ぶ。",
    href: "https://www.omron.com/sinicx/internship/",
  },
  {
    rank: "04",
    name: "NEC",
    role: "D2本格枠・D3短期枠を年度テーマで比較",
    facts: "2026年度は8〜9月中心で、一部長期・日程相談。共同論文へ進んだ公式事例もある。",
    fit: "人間モデリング、マルチモーダル認識、Agent AI、Physical AIが研究テーマに近い。",
    caution: "インターン中の発明・著作権等はNEC帰属。D2は2〜3か月、D3は最大4週間の実施可否と、博士論文利用・投稿可否を別途書面化する。",
  ...
  },
  {
    ...
    caution: "2029年度に既存研究へ接続できる2〜4週間のテーマがある場合だけ候補にする。知財はNTT帰属のため、論文公開・博士論文利用・終了後アクセスの書面許可がない場合も選ばない。",
  ...
  },
  {
    ...
    caution: "D2の2〜3か月枠として比較し、博士論文への接続、論文公開、知財、海外留学前の余白を明示合意できる場合だけ選ぶ。",
...
export const nttInternshipThemes = [
  ...
  },
  {
    ...
    text: "NTTs26064。視線・動作データに基づく触診インタラクションのマルチモーダル解析。4週間以上6週間未満の過年度テーマで、D3枠に使うなら最大4週間への調整可否を確認する。",
  },
  {
    key: "03",
...
export const toyotaEcosystem = [
  ...
  },
  {
    ...
    rule: "3か月はD2枠と合う。博士論文への接続と論文公開条件を明示合意できる場合だけ選ぶ。",
...
export const internshipStrategyOptions = [
  ...
  },
  {
    label: "D2 · 論文2",
    title: "別企業で研究文化を比較",
    text: "OMRON、Sony、NEC、日立、Woven等から一社を選び、6〜8月の2〜3か月で本格研究を行う。9〜10月を成果整理・回復・渡航準備に使う。",
  },
  {
    label: "D3 · 条件付き追加検証",
    title: "受入先は条件で選ぶ",
    text:
      "NTT固定ではない。5月31日の学位ゲートを通過し、7月の骨子提出後も予備審査準備へ余裕がある場合だけ、8〜9月のうち2〜4週間で既存テーマを追加検証する。",
  },
];
...
export const internshipPrep = [
  ...
  },
  {
    ...
    title: "D2企業と海外をつなぐ",
    text:
      "D2企業は4月30日までに受入・契約・住居を確定。国内滞在成果は4月末に原稿化し、5月15日で新規実験を停止して、6〜8月の企業研究と11月の海外大学研究を守る。",
  },
  {
    time: "2028.10–2029.09",
    title: "D3は学位後ろ盾付き",
    text:
      "NTTを含む候補を監視し、5月31日に学位進捗で判定。7月の骨子提出後も予備審査まで十分な余白がある場合だけ、8〜9月のうち2〜4週間で実施する。",
  },
];
...
export const internshipGo = [
  ...
  "D1・D2は投稿原稿、D3は博士論文へ直接使える追加検証と再現可能な結果を持ち帰れる",
  "終了後6週間の執筆担当と投稿日が決まる",
  "次の外部滞在まで必要な余白を確保でき、D3は予備審査準備を妨げず9月中に終えられる",
];
...
export const overseasExploration = [
  ...
  },
  {
    ...
    items: [
      ...
      "D2企業を2028年6〜8月に実施し、9〜10月を投稿・回復・渡航準備に使う",
      "企業終了から海外開始まで最低4週間、可能なら8週間空ける",
...
export const overseasGo = [
  ...
  "9月末までにD2企業論文を投稿し、企業終了から海外開始まで最低4週間、計画上は8週間を確保",
  "倫理・データ移転・公開可否が確定",
  "ベースラインと予備実験が完了",
  "投稿先・著者順と帰国後6〜8週間を確保",
];
...
export const overseasDelay = [
  ...
  "論文公開・知財・著者条件が不明",
  "資金不足を現地アルバイトで補う前提",
  "D2企業論文が未投稿、企業終了から4週間未満、または睡眠・体調が不安定",
];
...
export const careerSteps = [
  ...
  ["D2 夏〜秋", "企業研究を実施・投稿し、最低4週間、計画上は8週間空けて海外へ"],
...
export const decisionGates = [
  ...
  },
  {
    ...
    title: "D2夏の企業研究",
    go:
      "一社で2〜3か月、受入先・期間・契約・住居・必要なJAIST手続き、別の研究質問、公開・知財、終了後アクセス、海外留学まで最低4週間の移行期間が確定",
    stop: "公開不可、博士論文利用不可、または海外準備を圧迫する場合は6〜8週間へ短縮し、それでも無理なら別企業または一方の活動を延期",
  },
  {
    time: "2028.09.30",
    title: "海外研究留学・最終GO",
    go: "D2企業論文が投稿済みで、企業終了から最低4週間、計画上は8週間、受入、資金、倫理、データ、住居・保険・ビザが揃う",
    stop: "企業論文未投稿、案件間隔4週未満、連絡空白、公開条件不明、健康不安のいずれかで延期",
  },
  {
    time: "2029.02",
    title: "引っ越し",
  ...
  },
  {
    ...
    title: "D3夏の条件付き受諾",
    go:
      "骨子が提出可能な完成版で、2〜4週間・既存テーマ・知財・博士論文利用・予備審査準備を妨げない一社と開始条件が確定",
  ...
  },
  {
    ...
    title: "D3夏の骨子後再確認",
    go:
      "学位論文骨子を正式提出済みで、初稿70%以上、主要論文投稿、指導教員承認が維持されている",
    stop: "骨子未提出または博士論文進捗が悪化した場合は、研究所見学・面談へ縮小するか中止",
  },
  {
    time: "2029.09",
    title: "D3企業活動の終了",
    go: "短期活動を完全終了し、得られた小規模検証・研究所比較を博士論文または就職判断へ直接統合",
    stop: "追加実験や現地作業が残る場合は打ち切り、10月の予備審査願と博士論文を優先",
  },
  {
    time: "2029.10",
    title: "予備審査願",
...
export const riskRows = [
  ...
  ["D3企業の残務が続く", "9月末に追加実験・現地作業が残る", "既存結果で凍結し、博士論文と予備審査準備だけにする"],
];
...
export const recoveryWindows = [
  ...
  ["2028 D2企業後", "3〜5日＋海外開始まで最低4週間、計画上は8週間"],
  ["2029.01", "海外大学研究後1週間"],
  ["2029.07", "骨子提出後2〜3日"],
  ["2029.09", "D3企業終了後3〜5日、以後は博士論文と予備審査準備だけ"],
  ["2030.02", "公聴会後1週間"],
];
