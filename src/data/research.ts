...
const projectNormalization: ProjectNormalization[] = [
  ...
  {
    id: "d1-overseas-university-research",
    date: {
      start: "2027-10",
      end: "2028-03",
      precision: "月",
      display: "D1 · 2027.10–2028.03",
    },
    phase: "D1",
    category: "海外研究",
    status: "予定",
...
export const thesisChapterRelations: ThesisChapterRelation[] = [
  ...
  {
    id: "chapter-d1-overseas",
    label: "D1 · 2027年10月〜2028年3月",
